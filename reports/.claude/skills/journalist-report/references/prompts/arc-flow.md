...
**Test:** If the reader can identify where one arc ends and another begins, you've failed. Arc boundaries should feel like a conversation topic shifting, not a chapter break.
...
### Callback Seeds
Plant specific details in one arc that pay off in another:
...
### Convergence Point
Identify where all arcs meet (usually mid-THE STORY):
...
### Sequential Chapter Structure (BAD)
```
THE STORY:
- "First, the funding scandal..." (Arc A complete)
- "Next, the cover-up..." (Arc B complete)
- "Finally, the money trail..." (Arc C complete)
```

This is a character catalog disguised as arcs. Arcs should INTERWEAVE.

### No Recontextualization (BAD)
Every paragraph only makes sense in isolation. Later reveals don't change how earlier paragraphs read.

### Missing Callbacks (BAD)
Details are planted but never pay off. Or payoffs appear without setup.

### No Convergence (BAD)
Arcs exist in parallel but never collide. The reader doesn't see how they connect.
