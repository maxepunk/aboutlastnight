...
- THE PLAYERS evaluates (pull quotes for standout moments)
- WHAT'S MISSING intrigues (prose explores the silence)
...
[VISUAL BREAK: evidence card, pull quote, or photo]
...
[PHOTO - emotional beat, humanize character, breathing room]
...
**Component Frequency Guidelines (GUIDELINES, not quotas):**

Visual components EARN their place by serving the narrative. These are soft guidelines:
- Evidence cards: Sidebar holds curated ~10 as reference; inline placement as needed
- Photos: Woven into sections for emotional pacing
- Pull quotes: 2-3 for true crystallization moments
...
The sidebar displays curated evidence cards as a "bibliography" for reference. The SAME cards appear inline where they hit hardest in the prose. These are not different sets of evidence.
...
- Photos feel like reporter documentation of the scene
...
- [ ] Evidence cards at key narrative moments (quality over quantity)
- [ ] Financial tracker in FOLLOW THE MONEY
- [ ] Photos placed for emotional pacing (humanize before revelation, breathe after intensity)
- [ ] **Photo distribution**: Avoid clustering images in opening paragraphs - spread across sections
- [ ] Pull quotes at 2-3 emphatic moments
- [ ] Visual weight matches narrative importance
- [ ] The article feels like a compelling GIFT for players

---

## 7. Photo Distribution

> **Photo & Visual Component Rules**: See `<narrative-structure>` Section 8 for authoritative guidance on section appropriateness and visual component placement.

**Core principle:** Avoid frontloading visual content. Readers need breathing room between images.

**Anti-pattern:** All photos in THE LEDE and first arc → later sections feel text-heavy by comparison.
